...
echo "<b><tr><td>No.</td><td>Nama Customer</td><td>Alamat Customer</td><td>Tanggal Pesan</td><td>Total Barang</td><td>Total Biaya</td><td colspan=2><center> Aksi</center></td></tr>";
if ($data->num_rows > 0){
  $no = 1;
  while ($row = $data->fetch_assoc()) {
    ...
    echo "<td><a href='nota.php?user=".$row['Nama_Customer']."'>Cetak</a></td>";
